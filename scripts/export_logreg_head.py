...
Upload both to the Hugging Face repo named by BioCLIPClassifier.head_repo_id, in
trapdata/ml/models/bioclip.py. The classifier downloads them from there with
