#!/usr/bin/env bash
#
# Tunnel this service, running on a remote GPU host, into a local Antenna stack.
#
# The BioCLIP classifier needs a GPU to be worth running, so it is usually served from
# a remote host while Antenna runs locally.
#
